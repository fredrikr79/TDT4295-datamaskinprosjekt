...
## Pmod Header JA
## Pmod VGA - J1 on header JA (red + blue)
...
## Pmod Header JB
## Pmod VGA - J2 on header JB (green + syncs)
...
set_property -dict { PACKAGE_PIN J17  IOSTANDARD LVCMOS33 } [get_ports { vga_hsync }];
set_property -dict { PACKAGE_PIN J18  IOSTANDARD LVCMOS33 } [get_ports { vga_vsync }];
...
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports in_full]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports in_almost_full]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports out_empty]
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports out_almost_empty]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports acknack]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {octo_spi[0]}]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {octo_spi[1]}]
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {octo_spi[2]}]
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports {octo_spi[3]}]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {octo_spi[4]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {octo_spi[5]}]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {octo_spi[6]}]; #IO_L12N_T1_MRCC_14           Sch=ck_io[12]
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports {octo_spi[7]}]; #IO_L12P_T1_MRCC_14           Sch=ck_io[13]
...
## MCU Master clock
create_clock -period 50.000 -name spi_clk [get_ports ck_sck]
...
connect_debug_port u_ila_1/probe3 [get_nets [list ck_ss_IBUF]]
